...
<template>
  <DefaultLayout>
    <div class="p-4 min-h-full">
      ...
      <!-- <Galleria :value="product.photos" :responsiveOptions="responsiveOptions" :numVisible="5" containerStyle="max-width: 500px">
      ...
      <!-- <img :src="photo as string" alt="" v-for="photo, i in product.photos" :key="i"> -->
    </div>    
  </DefaultLayout>
</template>
<style>
