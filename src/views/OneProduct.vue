...
const addCart = ()=>{
  cart.addProduct({...product.value, count: count.value})
}
const addGoCart = ()=>{
  cart.addProduct({...product.value, count: count.value})
  goCart()
    ...
    <div class="p-4 min-h-full">
      ...
      <div class="grid grid-cols-2 gap-6">
        ...
        <div>
          ...
          <div class="p1_button p1_1 mb-4 font-semibold" @click="addCart">Добавить в корзину</div>
          <div class="p1_button p1_2 mb-8" @click="addGoCart">Купить сейчас</div>
